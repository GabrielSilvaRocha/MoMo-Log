...
export type AppView = 'dashboard' | 'planning' | 'workout' | 'running' | 'analytics' | 'history' | 'goals' | 'exercises' | 'adaptation'
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (queryView && ['dashboard', 'planning', 'workout', 'running', 'analytics', 'history', 'goals', 'exercises', 'adaptation'].includes(queryView)) {
